...
class RNN_GKO_GNN_Model(nn.Module):
    ...
    def forward(self, data):
        ...
        _, T = temp_seq.shape
        delta_t_seq = torch.tensor([1.0] * (T - 1) + [120.0], device=temp_seq.device)
...
if __name__ == "__main__":
    ...
    DeepONetModel = RNN_GKO_GNN_Model()
    print("training......")
    train_deeponet(DeepONetModel, train_loader, test_loader, epochs=50000, lr=1e-6, save_dir="./training_logs", patience=10)
